...
//                ->get();
    ...
    public function getWaitingPay( Request $request)
    {
        ...
        $query = Subscription::leftJoin('customers', 'subscriptions.customer_id', '=', 'customers.id')
           ...
           $query->select('subscriptions.*', 'customers.phone', 'customers.comments','customers.name','reasons.title','products.title AS ptitle','users.name AS user_name');
...
//        }
        ...
        $subscriptions->select('subscriptions.*', 'customers.comments','customers.phone', 'customers.name','products.title AS ptitle')
