...
<!--&lt;!&ndash;                    <input type="text" :name="'productUsers['+ productUserId +'][stake]'" id="" v-model="productUserAccount.stake" class="form-control" placeholder="Процентная ставка">&ndash;&gt;-->
