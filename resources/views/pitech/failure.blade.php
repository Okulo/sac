...
<div class="container">
    <div class="wrapper" id="app">
        <div class="container">
        <div class="row popup-pay card-form__inner" style="
            ...
            <div class="col-sm-6">
				<div class="trener-body">
					<div style="display: flex; margin: 13px 0px;">
						<img src="/images/error.svg" alt="" style="height: 40px;margin-right: 12px; vertical-align: middle;">
							<h2 class="content-heading" style="margin: auto 0;">
								Ошибка оплаты!
							</h2>
						</div>
				</div>
                <hr>
                Пожалуйста, повторите попытку позже, или обратитесь к менеджеру
            </div>
        </div>
        </div>
    </div>
