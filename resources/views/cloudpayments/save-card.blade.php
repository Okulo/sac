                        ...
                        <div class="row">
                            <div class="col-sm-12"
                                ...
                                <p style="line-height: 19px">Безопасность платежей обеспечивается банковской системой
                                    Республики Казахстан и <a href="https://cloudpayments.kz"
                                                              target="_blank">Cloudpayments.kz</a>
                                </p>
                            </div>
                            <div class="col-sm-5">
                                <div class="card-input">
                                    <label class="card-input__label">Имя</label>
                                    <input type="text" class="card-input__input" value="{{ $customer->name }}" disabled>
                                </div>
                                <div class="card-input">
                                    <label class="card-input__label">Телефон абонента</label>
                                    <the-mask :masked="false" mask="+# (###) ### ##-##" type="text"
                                              class="card-input__input" id="phone" value="{{ $customer->phone }}" required disabled>
                                    </the-mask>
                                </div>
                                {{--<div class="card-input">
        ...
        $( "#cloudpayment-widget-form" ).submit(function( event ) {
            ...
            widget.pay('auth', // или 'charge'
                { //options
                    ...
                    amount: 5, //сумма
                    currency: 'KZT', //валюта
                    accountId: '<?=$customer->id;?>', //идентификатор плательщика (необязательно)
                    invoiceId: now, //номер заказа  (необязательно)
                    email: '<?=$customer->email;?>', //email плательщика (необязательно)
                    skin: "modern"
                },
                {
